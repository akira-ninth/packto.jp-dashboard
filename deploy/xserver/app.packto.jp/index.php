...
/*
 * Xserver の app.packto.jp ドキュメントルート用ブートストラップ
 *
 * Xserver の仕様で /app.packto.jp/ がこのサブドメインの doc root になっている。
 * Laravel 本体は doc root の外 (/packto-console/) に置いて、ここから 1 つ上の階層を
 * 経由して参照する。
 *
 * 注意: admin.packto.jp/index.php と完全に同一の内容。Laravel が Host ヘッダを見て
